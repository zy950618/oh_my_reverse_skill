...
required_regression: run `python3 public-range-evidence/airline-lab-order-flow/replay/replay.py`
...
required_regression: run `python3 public-range-evidence/airline-lab-order-flow/tests/run_order_flow_tests.py`
...
owner_notes: local-only; no live airline calls, no payment, no account, no challenge/WAF bypass
