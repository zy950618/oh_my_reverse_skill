...
This contract fixes the entry order for Web/H5 reverse-engineering skills so business delivery, loop orchestration, pure API delivery, challenge model delivery, and fingerprint risk diagnostics do not compete for the same trigger.
