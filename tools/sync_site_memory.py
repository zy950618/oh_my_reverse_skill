...
TARGET_FILES = {
    ...
    "knowledge-graph.md": ["知识图谱", "图谱", "节点", "边", "关联", "依赖", "lineage", "graph", "dependency", "relation"],
    "impact-regression.md": ["影响", "回归", "改动", "数据偏移", "写死", "请求头", "指纹", "impact", "regression", "drift", "hardcode"],
