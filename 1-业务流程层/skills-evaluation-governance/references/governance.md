...
- 0.4.2: Added governance boundary for local positive evidence; local positive evidence must stay scoped to self-owned localhost risk-lab mechanics and cannot be scored as third-party challenge/WAF/fingerprint or production concurrency capability.
...
- 0.4.2: Added high-fidelity local risk-lab scope boundaries.
- 0.4.3: Added business data assertion admission gate; evidence without DATA_ASSERTION_PASS is not positive_allowed even when direct replay or control flow passes.
